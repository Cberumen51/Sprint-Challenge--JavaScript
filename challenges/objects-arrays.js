...
const displayNames = (zooAnimals) => {
  let names = [];
  zooAnimals.forEach(zooAnimal => names.push(`Name: ${zooAnimal.animal_name}, Scientific: ${zooAnimal.scientific_name}.` ))
  return names;
}
...
const populationTotal = (zooAnimals) => {
  return zooAnimals.reduce((totalPopulation, zooAnimal) => totalPopulation + zooAnimal.population, 0)
}
